...
<x-app-layout>
    ...
    <div class="card bg-white shadow-xl basis-1/5 rounded-xl text-black ">
        <div class="card-body">
                ...
                <div class="grid grid-cols-3">
                    <div>
                        ...
                        @if (Carbon::create($borrow->borrow_date)->greaterThan(Carbon::create($borrow->due_date)))
                            <p
                                class="w-fit p-[6px_10px] rounded-[10px] bg-[#FD445E] font-bold text-xs text-black  outline-[2px] outline-offset-[4px] mr-[6px]">
                                Late</p>
                    ...
                    <div class="col-span-2">
                        <p class=" text-black text-2xl font-bold mb-4">{{ $borrow->book->title }}</p>
                        <p class=" text-black text-md mb-8">{{ $borrow->book->author->name }}</p>
                        ...
                        <p class=" text-black text-2xl font-bold mt-8 mb-4">Peminjam : {{ $borrow->student->name }}</p>
            ...
            <div class="card-action"><a href="{{ route('borrows.index') }}"><input type="submit" value="Back"
                ...
                <form action="{{ route('borrow_returns.store', $borrow) }}" method="post" class="inline">@csrf<button
                        type="submit" class="btn btn-error bg-[#B8292D] text-white w-fit">Mark as Returned</button>

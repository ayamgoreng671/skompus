            ...
            <div>
                <div class="grid grid-cols-3">
                    ...
                    <div class="col-span-2">
                        <p class=" text-white text-2xl font-bold mb-4">{{ $book->title }}</p>
                        <p class=" text-white text-md mb-8">{{ $book->author->name }}</p>
                        ...
                        <p class="text-white text-xl my-4">Deskripsi Singkat :</p>
                        ...
                        <div class="card-action"><a href="{{ route('books.index') }}"><input type="submit"
                            ...
                            @if ($book->is_borrowed == 0)
                                <a href="{{ route('books.borrow', $book) }}" class="btn btn-primary w-fit">Borrow</a>
                        </div>
                        @endif

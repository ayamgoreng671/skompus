<x-app-layout>
    <p class="font-bold text-4xl text-black mb-4">Data Buku</p>
            ...
            <form action="{{ route('books.store') }}" class="form-control" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-4 text-black">
                    ...
                    <div><x-input-label for="author" :value="__('Author')" /><select name="author"
                            class="select select-bordered w-full max-w-xs bg-white border-black border-2 @error('author')
                            select-error 
                            @enderror">
                    ...
                    <div><x-input-label for="publisher" :value="__('Publisher')" /><select name="publisher"
                            class="select bg-white border-black border-2 select-bordered w-full max-w-xs @error('publisher')
                            select-error 
                            @enderror">
                    ...
                    <div><x-input-label for="category" :value="__('Category')" /><select name="category"
                        class="select bg-white border-black border-2 select-bordered w-full max-w-xs @error('category')
                        select-error 
                        @enderror">
                    ...
                    <div> <x-input-label for="cover" :value="__('Cover')" class="" />
                        <input name="cover" type="file"
                            class="file-input file-input-bordered w-full max-w-xs bg-white border-black border-2 @error('cover')
                        file-input-error 
                        @enderror " />
                ...
                <textarea name="description" id="" cols="30" rows="3"
                    class="textarea textarea-bordered mb-2 bg-white border-black border-2 @error('description')
                        textarea-error 
                        @enderror"
